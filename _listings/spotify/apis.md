...
- name: Spotify
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/spotify/master/_listings/spotify/users-user-id-playlists-playlist-id-tracks-put.md
x-common:
